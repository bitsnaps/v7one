<script setup>
import { ref } from 'vue';
import { BCollapse, BNavItemDropdown, BDropdownItem } from 'bootstrap-vue-next';

const isNavCollapsed = ref(true); // Initialize as collapsed, Bootstrap's toggler will manage it
</script>
