...
<template>
    <div class="container">
        ...
        <form @submit.prevent="submitForm">
            ...
            <div class="mb-3">
                <label for="deal" class="form-label">Deal Details</label> 
                <textarea class="form-control" id="deal" v-model="formData.deal" rows="5" required></textarea>
            </div>
